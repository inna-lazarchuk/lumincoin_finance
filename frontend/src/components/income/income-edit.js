...
export class IncomeEdit {
    ...
    async getCategory(id){
        let result = await IncomeService.getCategory(id);
        ...
        document.getElementById('edit-cancel').addEventListener('click', () => this.openNewRoute('/income'));
    ...
    async editCategory(e)  {
        ...
        let result = await IncomeService.editCategory(id, newTitleCategory);
        if(result.error) {
            console.log('Ошибка запроса');
        }
